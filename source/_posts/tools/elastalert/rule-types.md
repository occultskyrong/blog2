...
- [5. 规则类型](#5-规则类型)
    ...
    - [5.9. Cardinality](#59-cardinality)
...
| `generate_kibana_link`    | `boolean`        | `False`                    |          |                                                                |
...
| Rule                      | Type             | Default   | Any | Blacklist | Whitelist | Change | Frequency | Spike | Flatline | New_term | Cardinality |
| ------------------------- | ---------------- | --------- | --- | --------- | --------- | ------ | --------- | ----- | -------- | -------- | ----------- |
...
默认情况下，将运行`rules_folder`中以`.yaml`结尾的每个文件。
以下配置设置适用于所有类型的规则。
